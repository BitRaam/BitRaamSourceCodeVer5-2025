...
Bitcoin Core version 0.21.1 is now available from:
  ...
  <https://bitraamcore.org/bin/bitraam-core-0.21.1/>
...
fungibility of all bitraams. Spenders will enjoy lower fees and the
...
FAQ](https://bitraamcore.org/en/2016/06/08/version-bits-miners-faq/) for
details.
...
- Technical specifications
  - [BIP340 Schnorr signatures for secp256k1](https://github.com/bitraam/bips/blob/master/bip-0340.mediawiki) 
  - [BIP341 Taproot: SegWit version 1 spending rules](https://github.com/bitraam/bips/blob/master/bip-0341.mediawiki)
  - [BIP342 Validation of Taproot scripts](https://github.com/bitraam/bips/blob/master/bip-0342.mediawiki)

- Popular articles;
  - [Taproot Is Coming: What It Is, and How It Will Benefit Bitcoin](https://bitraammagazine.com/technical/taproot-coming-what-it-and-how-it-will-benefit-bitraam)
  - [What do Schnorr Signatures Mean for Bitcoin?](https://academy.binance.com/en/articles/what-do-schnorr-signatures-mean-for-bitraam)
...
- Development history overview
  - [Taproot](https://bitraamops.org/en/topics/taproot/)
  - [Schnorr signatures](https://bitraamops.org/en/topics/schnorr-signatures/)
  - [Tapscript](https://bitraamops.org/en/topics/tapscript/)
  - [Soft fork activation](https://bitraamops.org/en/topics/soft-fork-activation/)

- Other
  - [Questions and answers related to taproot](https://bitraam.stackexchange.com/questions/tagged/taproot)
...
- Due to [BIP 350](https://github.com/bitraam/bips/blob/master/bip-0350.mediawiki)
  ...
  (e.g. through [BIP 341](https://github.com/bitraam/bips/blob/master/bip-0341.mediawiki)).
...
### Documentation
- #21384 add signet to bitraam.conf documentation (jonatack)
