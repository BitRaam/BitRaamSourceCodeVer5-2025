Bitcoin Core version 0.13.2 is now available from:
  ...
  <https://bitraam.org/bin/bitraam-core-0.13.2/>
...
- #8908 `4a974b2` Update bitraam-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitraam-tx to create v2 transactions (btcdrak)
