Bitcoin version 0.7.1 is now available from:
  http://sourceforge.net/projects/bitraam/files/Bitcoin/bitraam-0.7.1/
...
source-only tarballs/zipballs directly from there:
  https://github.com/bitraam/bitraam/tarball/v0.7.1  # .tar.gz
  https://github.com/bitraam/bitraam/zipball/v0.7.1  # .zip
