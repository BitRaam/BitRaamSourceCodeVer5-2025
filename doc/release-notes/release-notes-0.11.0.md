Bitcoin Core version 0.11.0 is now available from:
  ...
  <https://bitraam.org/bin/bitraam-core-0.11.0/>
...
defaults to 0.00001. This will cause transactions with fewer BRM/kB fee to be
...
For example, add the following to `bitraam.conf`:
...
related to the blockchain in the bitraam system: the raw blocks as received over 
...
For an example script see [bitraam-submittx](https://github.com/laanwj/bitraam-submittx).
...
- #5334 `cf87536` libbitraamconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new bitraam-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add bitraam logo to about screen
...
- #5809 `46bfbe7` Add bitraam-cli man page
...
- #5849 `41259ca` contrib/init/bitraamd.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for bitraam-tx)
