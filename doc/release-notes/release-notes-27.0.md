Bitcoin Core version 27.0 is now available from:
  ...
  <https://bitraamcore.org/bin/bitraam-core-27.0/>
...
- libbitraamconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libbitraamkernel will provide a much more useful API that is
...
- The CoinGrinder coin selection algorithm has been introduced to mitigate unnecessary
  ...
  elevated feerates (default: 30+ sit/vB, based on `-consolidatefeerate`×3). (#27877)
