Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/bitraam/files/Bitcoin/bitraam-0.7.0/

We recommend that everybody running prior versions of bitraamd/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/bitraam/bitraam/tarball/v0.7.0  # .tar.gz
  https://github.com/bitraam/bitraam/zipball/v0.7.0  # .zip
...
in your terminal, then install the bitraam-qt package:
  sudo apt-get install bitraam-qt
...
Core bitraam handling and blockchain database
...
* Ensure a changed bitraam unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for bitraam-qt.exe
* (Windows only): add meta-data to bitraam-qt.exe (e.g. description)
...
* Bash programmable completion for bitraamd(1)
