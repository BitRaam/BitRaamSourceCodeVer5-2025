...
Assumeutxo is a feature that allows fast bootstrapping of a validating bitraamd
instance.
...
```
$ bitraam-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ bitraam-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
