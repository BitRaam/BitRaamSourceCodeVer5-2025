...
[BIP 174](https://github.com/bitraam/bips/blob/master/bip-0174.mediawiki)).
...
the command line in case `bitraam-cli` is used.
...
Later, when *V* BRM has been received on *Amulti*, and Bob and Carol want to
