...
Multiple tools can list the available tracepoints in a `bitraamd` binary with
USDT support.
...
```
$ gdb ./build/src/bitraamd
…
(gdb) info probes
Type Provider   Name             Where              Semaphore Object
stap net        inbound_message  0x000000000014419e 0x0000000000d29bd2 /build/src/bitraamd
stap net        outbound_message 0x0000000000107c05 0x0000000000d29bd0 /build/src/bitraamd
stap validation block_connected  0x00000000002fb10c 0x0000000000d29bd8 /build/src/bitraamd
…
```
...
```
$ readelf -n ./build/src/bitraamd | grep NT_STAPSDT -A 4 -B 2
