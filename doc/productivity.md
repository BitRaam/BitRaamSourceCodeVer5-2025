...
```sh
cmake --build build --target bitraamd bitraam-cli
cmake --build build --target bitraam-qt
cmake --build build --target bench_bitraam
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:bitraam/bitraam.git
```
