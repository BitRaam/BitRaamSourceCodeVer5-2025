...
```sh
DOCKER_BUILDKIT=1 docker build -t bitraam-linter --file "./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/bitraam -it bitraam-linter
```
...
maintained:
* for `src/secp256k1`: https://github.com/bitraam-core/secp256k1.git (branch master)
* for `src/leveldb`: https://github.com/bitraam-core/leveldb-subtree.git (branch bitraam-fork)
* for `src/crypto/ctaes`: https://github.com/bitraam-core/ctaes.git (branch master)
* for `src/crc32c`: https://github.com/bitraam-core/crc32c-subtree.git (branch bitraam-fork)
* for `src/minisketch`: https://github.com/sipa/minisketch.git (branch master)

To do so, add the upstream repository as remote:

```
git remote add --fetch secp256k1 https://github.com/bitraam-core/secp256k1.git
```
