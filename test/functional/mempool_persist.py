...
By default, bitraamd will dump mempool on shutdown and
...
class MempoolPersistTest(BitRaamTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bitraamd from writing mempool.dat to disk. Verify that `savemempool` fails")
