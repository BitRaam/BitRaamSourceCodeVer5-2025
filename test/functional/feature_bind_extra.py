...
"""
Test starting bitraamd with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(BitRaamTestFramework):
    ...
    def run_test(self):
        for i, (args, expected_services) in enumerate(self.expected):
            ...
            # that bitraamd has bound on "::1" (for RPC) and "::" (for P2P).
