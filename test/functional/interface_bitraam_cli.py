...
# The block reward of coinbaseoutput.nValue (50) BRM/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 BRM/block.
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"bitraam-cli -h\" for help or \"bitraam-cli listwallets\" to see "
...
class TestBitcoinCli(BitRaamTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `bitraam-cli getblockchaininfo`")
        ...
        # Prevent bitraam-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and bitraam-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and bitraam-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (BRM/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (BRM/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 BRM) to the default wallet.
            ...
            # Test bitraam-cli -generate with -rpcwallet in multiwallet mode.
