...
This file is modified from python-bitraamlib.
"""
...
def bn2vch(v):
    """Convert number to bitraam-specific little endian format."""
...
def FindAndDelete(script, sig):
    """Consensus critical, see FindAndDelete() in Maharishi codebase"""
    r = b''
