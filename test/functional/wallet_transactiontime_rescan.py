...
class TransactionTimeRescanTest(BitRaamTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine BRM and create transactions
        ...
        # generate some brm to create transactions and check blockcount
        ...
        # send 10 brm to user's first watch-only address
        self.log.info('Send 10 brm to user')
        ...
        # send 5 brm to our second watch-only address
        self.log.info('Send 5 brm to user')
        ...
        # send 1 brm to our third watch-only address
        self.log.info('Send 1 brm to user')
