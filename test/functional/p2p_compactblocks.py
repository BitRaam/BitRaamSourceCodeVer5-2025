...
# TestP2PConn: A peer we use to send messages to bitraamd, and store responses.
...
class CompactBlocksTest(BitRaamTestFramework):
    ...
    # This test actually causes bitraamd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that bitraamd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for bitraamd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # bitraamd will not send blocktxn responses for blocks whose height is
