...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The bitraamd node closes feeler connections as soon as a version
...
class P2PAddConnections(BitRaamTestFramework):
    ...
    def run_test(self):
        ...
        # bitraamd behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that bitraamd sends its own version prior to processing
