...
Verify that a bitraamd node can use an external signer command.
...
class RPCSignerTest(BitRaamTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart bitraamd with -signer=<cmd>',
