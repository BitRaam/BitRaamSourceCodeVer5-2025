...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitraam with -h for help text")
        ...
        self.log.info("Start bitraam with -version for version information")
        ...
        self.log.info("Start bitraamd with -fakearg to make sure it does not start")
