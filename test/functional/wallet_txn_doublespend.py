...
class TxnMallTest(BitRaamTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 BRM:
        ...
        # First: use raw transaction API to send 1240 BRM to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 BRM coin each
        ...
        # Node0's balance should be starting balance, plus 50BRM for another
        ...
        # Node0's total balance should be starting balance, plus 100BRM for
