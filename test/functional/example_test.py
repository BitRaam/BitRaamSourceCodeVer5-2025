...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BitRaamTestFramework
    pass


class ExampleTest(BitRaamTestFramework):
    # Each functional test is a subclass of the BitRaamTestFramework class.
    ...
    def custom_method(self):
        ...
        BitRaamTestFramework class so other tests can use it."""
