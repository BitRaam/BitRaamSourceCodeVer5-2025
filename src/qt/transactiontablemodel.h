...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, BitRaamUnits::SeparatorStyle separators=BitRaamUnits::SeparatorStyle::STANDARD) const;
