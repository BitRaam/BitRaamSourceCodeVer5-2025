...
//! Entry point for BitRaamApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BitRaamApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BitRaamGUI tests.
void AppTests::guiTests(BitRaamGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BitRaamGUI::consoleShown, this, &AppTests::consoleTests);
