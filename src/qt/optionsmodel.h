...
/** Interface from Qt to configuration data structure for BitRaam client.
...
public:
    ...
    BitRaamUnit getDisplayUnit() const { return m_display_bitraam_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSBRMontrols() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    BitRaamUnit m_display_bitraam_unit;
...
Q_SIGNALS:
    void displayUnitChanged(BitRaamUnit unit);
