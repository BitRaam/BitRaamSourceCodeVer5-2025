...
#include <algorithm>
#include <attributes.h> // Added for BitRaam Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for BitRaam Core
#include <util/string.h> // Added for BitRaam Core
...
// Added for BitRaam Core. Similar to std::runtime_format from C++26.
...
// Added for BitRaam Core. Wrapper for checking format strings at compile time.
