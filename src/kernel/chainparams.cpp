...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256{"0000055d0a3daa9c4b0d3629d3e9ba64f3cfa29643da9939b889d9d69a736b4e"}; // 0
        ...
        vSeeds.emplace_back("seednode.bitraam.org."); // Pieter Wuille, only supports x1, x5, x9, and xd
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.bitraam.org.");
...
public:
    CTestNet4Params() {
        ...
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("seed.testnet4.bitraam.sprovoost.nl."); // Sjors Provoost
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        if (!options.challenge) {
            ...
            vSeeds.emplace_back("seed.signet.bitraam.sprovoost.nl.");
