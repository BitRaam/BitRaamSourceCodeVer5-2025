...
{
    BOOST_CHECK(TestSplitHost("www.bitraamcore.org", "www.bitraamcore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.bitraamcore.org]", "www.bitraamcore.org", 0));
    BOOST_CHECK(TestSplitHost("www.bitraamcore.org:80", "www.bitraamcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitraamcore.org]:80", "www.bitraamcore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:31415", "127.0.0.1", 31415));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:31415", "127.0.0.1", 31415));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:31415", "::ffff:127.0.0.1", 31415));
    BOOST_CHECK(TestSplitHost("[::]:31415", "::", 31415));
    BOOST_CHECK(TestSplitHost("::31415", "::31415", 0));
    BOOST_CHECK(TestSplitHost(":31415", "", 31415));
    BOOST_CHECK(TestSplitHost("[]:31415", "", 31415));
    ...
    BOOST_CHECK(TestSplitHost("www.bitraamcore.org:65536", "www.bitraamcore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.bitraamcore.org:0", "www.bitraamcore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.bitraamcore.org:", "www.bitraamcore.org:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:31415", "127.0.0.1:31415"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:31415", "[::]:31415"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
