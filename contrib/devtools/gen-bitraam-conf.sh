...
BITCOIND=${BITCOIND:-$BINDIR/bitraamd}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/bitraam.conf}
...
then
  ...
  echo -e "To safely generate a bitraam.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example bitraam.conf file in share/examples/'
...
## Generated by contrib/devtools/gen-bitraam-conf.sh.
##
...
# parse the output from bitraamd --help
