...
"""Example logging BitRaam Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/bitraamd
...
def main(pid):
    ...
    b = BPF(text=program, usdt_contexts=[bitraamd_with_usdts])
