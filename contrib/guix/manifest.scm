...
(define* (make-bitraam-cross-toolchain target
                                       #:key
...
desirable for building BitRaam Core release binaries."
...
;; failure; see https://github.com/bitraam/bitraam/pull/27296.
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list bison
                 ...
                 (make-bitraam-cross-toolchain target)))
