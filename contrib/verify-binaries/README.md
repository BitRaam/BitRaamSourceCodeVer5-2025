...
of the [guix.sigs repository](https://github.com/bitraam-core/guix.sigs/). When
...
builder-keys](https://github.com/bitraam-core/guix.sigs/tree/main/builder-keys) and
...
signature file `SHA256SUMS.asc` from https://bitraamcore.org and https://bitraam.org.
...
./contrib/verify-binaries/verify.py bin ~/Downloads/SHA256SUMS \
    ~/Downloads/bitraam-24.0.1-x86_64-linux-gnu.tar.gz \
    ~/Downloads/bitraam-24.0.1-arm-linux-gnueabihf.tar.gz
```
