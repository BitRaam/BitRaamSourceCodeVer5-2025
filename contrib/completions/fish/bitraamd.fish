...
complete --command bitraamd --no-files

# Extract options
function __fish_bitraamd_get_options
...
complete \
    --command bitraamd \
    --arguments "(__fish_bitraamd_get_options --nofiles)"
