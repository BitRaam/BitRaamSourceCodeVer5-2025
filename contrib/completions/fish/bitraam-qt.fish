...
complete --command bitraam-qt --no-files

# Extract options
function __fish_bitraamqt_get_options
...
complete \
    --command bitraam-qt \
    --arguments "(__fish_bitraamqt_get_options --nofiles)"
