...
# Extract options
function __fish_bitraam_tx_get_options
...
# Extract commands
function __fish_bitraam_tx_get_commands
...
complete \
    --command bitraam-tx \
    --condition "not __fish_bitraam_seen_cmd (__fish_bitraam_tx_get_commands --commandsonly)" \
    --arguments "(__fish_bitraam_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command bitraam-tx \
    --arguments "(__fish_bitraam_tx_get_commands)" \
    --no-files
